...
<div class="container">
    {!! Form::open(['method' => 'POST','action'=>'App\Http\Controllers\Admin_Quiz_Controller@store','files'=>true]) !!}
    ...
    <div class="form-group">
        ...
        {!! Form::select('Course-id',[''=>'Choose Option']+$Courses,'',['class'=>'form-control']) !!}
    </div>
